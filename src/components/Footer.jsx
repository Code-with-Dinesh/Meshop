...
<footer className="bg-gray-900 mt-5 text-white">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center text-white">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">MeShop</span>
              </a>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2023 <a href="/" class="hover:underline">Meshop™</a>. All Rights Reserved.
          </span>
